...
<body>
    <div class="card">
        ...
        <?php else: ?>
            <a href="<?php echo e($frontendRedirect); ?>" class="btn">المحاولة مرة أخرى</a>
        <?php endif; ?>
    </div>
</body>
</html>
<?php /**PATH D:\campCoding\Nartaqi-Back-end\Modules\Courses\resources\views\payment\failed.blade.php ENDPATH**/ ?>