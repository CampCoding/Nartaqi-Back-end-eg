...
<body class="bg-gray-50 flex items-center justify-center min-h-screen p-4">
    ...
    <div class="max-w-md w-full bg-white rounded-3xl shadow-2xl p-8 text-center">
        <div class="mb-6 flex justify-center">
            <?php if(isset($method) && $method == 'Wallet'): ?>
        ...
        <div class="flex justify-center mb-6 p-4 bg-gray-100 rounded-2xl">
            <img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=<?php echo e(urlencode($qrCode)); ?>" alt="QR Code" class="rounded-lg">
        </div>
        <?php endif; ?>
        ...
        <div class="bg-orange-50 border-2 border-dashed border-orange-200 rounded-2xl p-6 mb-8">
            ...
            <span class="text-4xl font-black text-orange-600 tracking-widest"><?php echo e($fawryCode); ?></span>
        </div>

        <div class="text-right space-y-3 mb-8">
            <div class="flex items-center text-gray-700">
                <div class="w-2 h-2 bg-orange-500 rounded-full ml-2"></div>
                <span class="text-sm">هذا الكود صالح حتى: <b><?php echo e($expireDate); ?></b></span>
            </div>
            <div class="flex items-center text-gray-700">
                <div class="w-2 h-2 bg-orange-500 rounded-full ml-2"></div>
...
<?php /**PATH D:\campCoding\Nartaqi-Back-end\resources\views\payment\fawry.blade.php ENDPATH**/ ?>